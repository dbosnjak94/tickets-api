...
router.get('/getAllUserTickets', authenticate, userController.getAllUserTickets)
router.post('/ticketPurchase', authenticate, creditCardValidatorUtil, userController.ticketPurchase)
